...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/guides/best-neighborhoods-near-the-lakes" },
};
    ...
    <main className="flex-1 bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16">
        ...
        <div className="relative w-full aspect-[21/9] mb-12 overflow-hidden">
          <Image
            src="/images/lakes/lake-paddleboarding-golden-hour.webp"
            alt="Stand-up paddleboarding on a Minneapolis lake at golden hour"
            fill
