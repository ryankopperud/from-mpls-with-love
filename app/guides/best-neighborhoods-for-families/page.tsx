...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/guides/best-neighborhoods-for-families" },
};
    ...
    <main className="flex-1 bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16">
        ...
        <div className="relative w-full aspect-[21/9] mb-12 overflow-hidden">
          <Image
            src="/images/parks/park-basketball-court-spring-blossoms.webp"
            alt="Minneapolis neighborhood park with spring blossoms"
            fill
