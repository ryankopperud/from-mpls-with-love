...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/guides/best-winter-neighborhoods" },
};
    ...
    <main className="flex-1 bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16">
        ...
        <div className="relative w-full aspect-[21/9] mb-12 overflow-hidden">
          <Image
            src="/images/winter/downtown-street-corner-snowfall-night.webp"
            alt="Downtown Minneapolis street corner during snowfall at night"
            fill
