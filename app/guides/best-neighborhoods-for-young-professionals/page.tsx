...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/guides/best-neighborhoods-for-young-professionals" },
};
    ...
    <main className="flex-1 bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16">
        ...
        <div className="relative w-full aspect-[21/9] mb-12 overflow-hidden">
          <Image
            src="/images/hero/rooftop-friends-skyline-dusk.webp"
            alt="Friends on a Minneapolis rooftop at dusk with skyline view"
            fill
