...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/guides/best-neighborhoods-for-retirees" },
};
    ...
    <main className="flex-1 bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16">
        ...
        <div className="relative w-full aspect-[21/9] mb-12 overflow-hidden">
          <Image
            src="/images/lakes/sailboats-minneapolis-lake-pink-dusk.webp"
            alt="Sailboats on a Minneapolis lake at pink dusk"
            fill
